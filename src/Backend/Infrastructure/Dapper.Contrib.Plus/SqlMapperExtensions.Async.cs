...
namespace Dapper.Contrib.Plus
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public static async Task<bool> DeleteAnyAsync<T>(this IDbConnection connection,
            IList<Condition> conditions = null,
            IDbTransaction transaction = null, int? commandTimeout = null) where T : class, new()
        {
            var name = GetTableName(typeof(T));
            ...
            var result = await connection.ExecuteAsync(sql, param: parameters, transaction: transaction, commandTimeout: commandTimeout);
